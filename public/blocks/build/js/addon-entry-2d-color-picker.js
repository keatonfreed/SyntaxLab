    ...
    return _regeneratorRuntime().wrap(function _callee$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          // 250-ms rate limit
          rateLimiter = new _libraries_common_cs_rate_limiter_js__WEBPACK_IMPORTED_MODULE_1__["default"](250); // get the color from scratch
          ...
          setColor = function setColor(hex, element) {
            ...
            var _onEyeDropperOpened = function onEyeDropperOpened(_ref3) {
          ...
          convertToGeneralColor = function convertToGeneralColor(hex) {
            var h = Object(_libraries_thirdparty_cs_tinycolor_min_js__WEBPACK_IMPORTED_MODULE_2__["default"])(hex).toHsv();
            h.s = 1;
            h.v = 1;
            ...
            return _regeneratorRuntime().wrap(function _loop$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  updateFinal = function _updateFinal(e, keyPressed, originalPos) {
                    rateLimiter.limit(function () {
                      ...
                      var color = Object(_libraries_thirdparty_cs_tinycolor_min_js__WEBPACK_IMPORTED_MODULE_2__["default"])(getColor(element)).toHsv();
                      var s = ox / 150;
                      var v = 1 - oy / 150;
                      var newColor = Object(_libraries_thirdparty_cs_tinycolor_min_js__WEBPACK_IMPORTED_MODULE_2__["default"])({
                        h: color.h,
                        s: s,
                        v: v,
                        a: color.a
                  ...
                  updateHandle = function _updateHandle(e, keyPressed, originalPos) {
                    ...
                    if ((!addon.tab.redux.state.scratchPaint.fillMode.gradientType || addon.tab.redux.state.scratchPaint.fillMode.gradientType === "SOLID") && el) {
                      var c = Object(_libraries_thirdparty_cs_tinycolor_min_js__WEBPACK_IMPORTED_MODULE_2__["default"])({
                        h: origHue,
                        s: cx / 150,
                        v: 1 - cy / 150
                      }).toHex();
                  ...
                  updateColor = function _updateColor() {
                    rateLimiter.limit(function () {
                      ...
                      var chsv = Object(_libraries_thirdparty_cs_tinycolor_min_js__WEBPACK_IMPORTED_MODULE_2__["default"])(c).toHsv();
                ...
                case 16:
                  ...
                  if (defaultColor) {
                    defaultHexColor = Object(_libraries_thirdparty_cs_tinycolor_min_js__WEBPACK_IMPORTED_MODULE_2__["default"])(defaultColor).toHsv();
