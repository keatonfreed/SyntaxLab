...
var EventTargetShim = /*#__PURE__*/function () {
  ...
  return _createClass(EventTargetShim, [{
...
var migrateSettings = function migrateSettings(settings) {
  ...
  if (oldVersion < 4) {
    var editorDevtools = settings['editor-devtools'];
...
var SettingsStore = /*#__PURE__*/function (_EventTargetShim) {
  function SettingsStore() {
    ...
    _this = _callSuper(this, SettingsStore);
  ...
  return _createClass(SettingsStore, [{
    ...
    value: function setStore(newStore) {
      ...
      for (var _i11 = 0, _Object$keys8 = Object.keys(oldStore); _i11 < _Object$keys8.length; _i11++) {
        ...
        if (JSON.stringify(oldSettings) !== JSON.stringify(newSettings)) {
          var manifest = this.getAddonManifest(addonId);
          // Dynamic enable is always supported.
          var dynamicEnable = !oldSettings.enabled && newSettings.enabled;
          // Dynamic disable requires addon support.
          var dynamicDisable = !!manifest.dynamicDisable && oldSettings.enabled && !newSettings.enabled;
    ...
    value: function evaluateCondition(addonId, condition) {
      var _this2 = this;
      if (!condition) {
      ...
      if (condition.addonEnabled) {
        ...
        var addonsToCheck = asArray(condition.addonEnabled);
        if (addonsToCheck.every(function (id) {
          return !_this2.getAddonEnabled(id);
        })) {
          return false;
        }
      }
      if (condition.settings) {
        // settings is an AND
        for (var _i12 = 0, _Object$entries4 = Object.entries(condition.settings); _i12 < _Object$entries4.length; _i12++) {
          var _Object$entries4$_i = _slicedToArray(_Object$entries4[_i12], 2),
            settingName = _Object$entries4$_i[0],
            expectedValue = _Object$entries4$_i[1];
