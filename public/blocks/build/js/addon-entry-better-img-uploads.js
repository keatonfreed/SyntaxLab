      ...
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _onchange = function _onchange3() {
            _onchange = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e, id) {
              var iD, el, files, processed, _loop2, _i, _files;
                ...
                while (1) switch (_context4.prev = _context4.next) {
                  case 0:
                    ...
                    _loop2 = /*#__PURE__*/_regeneratorRuntime().mark(function _loop2() {
                      var file, getImgData, img, dim, canvas, ctx, dataURL, originalDim, getResizedWidthHeight;
          ...
          _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
            var spriteSelector, stageSelector, costumeSelector, menu, button, id, isRight, _createItem, _createItem2, menuItem, hdButton, input, tooltip, observer, doresize;
            return _regeneratorRuntime().wrap(function _loop$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  spriteSelector = '[class*="sprite-selector_sprite-selector_"] [class*="action-menu_more-buttons_"]';
                  stageSelector = '[class*="stage-selector_stage-selector_"] [class*="action-menu_more-buttons_"]';
                  costumeSelector = '[data-tabs] > :nth-child(3) [class*="action-menu_more-buttons_"]';
                  _context.next = 6;
                  return addon.tab.waitForElement("".concat(spriteSelector, ", ").concat(stageSelector, ", ").concat(costumeSelector), {
                    markAsSeen: true,
